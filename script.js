...
function initCountdown() {
    // Target date: Wednesday, 16 September 2026 15:00:00 WITA
    const targetDate = new Date('2026-09-16T15:00:00+08:00').getTime();
...
const defaultWishes = [
    {
        ...
        attendance: 'Hadir',
        wish: 'Barakallahu lakuma wa baraka alaikuma wa jamaa bainakuma fii khair. Selamat menempuh hidup baru Lia & Al! Semoga selalu dilimpahi sakinah, mawaddah, dan warahmah.',
        timestamp: Date.now() - 3600000 * 2 // 2 hours ago
    },
    {
        name: 'Budi Santoso',
        attendance: 'Hadir',
        wish: 'Selamat ya Al! Lancar-lancar sampai hari H. Bahagia selalu selamanya bersama Lia.',
